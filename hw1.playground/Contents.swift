...
//: [They aren't necessarily since they are optional arguments (i.e. can get passed nil and String)]
...
//: [There needs to be a return for when the function works. This function needs to be a class method and thereby requires the keyword class before it.]
